...
from devp_us.training import TrainingConfig, train_graph_run


def main() -> None:
    parser = build_parser("Train the distributed graph model.")
    ...
    context = RunContext("train_distributed", paths, run_name=args.run_name, dry_run=args.dry_run)
    ...
    outputs = train_graph_run(context, paths, feature_registry, split_spec, args.dynamic_group, config, "distributed")
