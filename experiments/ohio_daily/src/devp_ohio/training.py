...
def train_graph_run(
    ...
    try:
        train_ds = GraphBatchDataset(batch_cache_root, dynamic_group, config.static_group, config.history_length, config.graph_batch_size, "train")
        val_ds = GraphBatchDataset(batch_cache_root, dynamic_group, config.static_group, config.history_length, config.graph_batch_size, "val")
        test_ds = GraphBatchDataset(batch_cache_root, dynamic_group, config.static_group, config.history_length, config.graph_batch_size, "test")
        context.info(
