...
OBSOLETE_RUN_IDS = {
    "ohio_monthly_semidistributed_core_snow_h12",
    "ohio_monthly_distributed_core_snow_h12_min",
}
...
def main() -> None:
    ...
    context.append_summary_markdown(markdown_path, "Ohio HUC05 Run Summary", "\n".join(body))
